  ...
  return (
    <section id="services" className="py-10 md:py-14 lg:py-16 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Сетка услуг */}
        {services.length === 0 ? (
          <div className="text-center text-gray-500 py-10">Услуги пока не добавлены</div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {services.map((service) => (
              <div
                key={service.id}
                // p-8 увеличивает отступы от краев карточки
                // h-full гарантирует одинаковую высоту карточек в ряду
              ...
              >
                ...
                {/* Контейнер для всех 3 частей с равномерными отступами между ними */}
                <div className="flex flex-col h-full gap-6">
                  
                  {/* 1 ЧАСТЬ: Лого и Заголовок */}
                  ...
                  {/* 3 ЧАСТЬ: Цена и кнопка (без изменений по оформлению) */}
